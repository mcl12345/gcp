...
function indexer($titre, $texte, $motscle) {
    $separateurs = "\",.'/<>()’!?;:|&\t\"\n\r\'_-=+@/*%{}[]#0123456789 "; //»«�‰–¶¸Ž

    // Récupére le titre et les motscle et la description
    $chaine_head = entitiesHTML2ASCII(strtolower($titre . " " . $motscle));
    ...
    $db_password = "root";
    $db_name = "basilique";
    $connexion = mysqli_connect("localhost", "phpmyadmin", "root", "basilique");
    ...
    echo "<br /><br /> sql_select : " . $sql_select . "<br />";
    ...
    foreach ($tab_mots_poids as $mot => $poids)
    {
        ...
        if(mysqli_num_rows($resultat_select))
        {
            ...
            if($nombre_insertion_mot_deja_inserer < 10) echo $mot . " est déjà enregistré<br />";
            ...
            if($resultat1 && $nombre_insertion_mot < 10) echo $sql1 , "<br />";
        }
        ...
        if($id_document != 0) {
            ...
            if($resultat && $nombre_insertion_mot_document < 10) echo $sql2 , "<br />";
        }
    }

    echo "<br /><br />Nombre d'enregistrement dans la table <strong>mot</strong> : " . $nombre_insertion_mot . "<br />";
    echo "Nombre d'enregistrement dans la table <strong>mot_document</strong> : " . $nombre_insertion_mot_document . "<br />";
    echo "Nombre d'enregistrement déjà inséré dans la table <strong>mot</strong> : " . $nombre_insertion_mot_deja_inserer . "<br />";
